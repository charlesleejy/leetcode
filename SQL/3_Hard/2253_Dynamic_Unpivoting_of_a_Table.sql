...
BEGIN
    ...
    -- Initialize variable to store the dynamically generated SQL
    SET @macro = NULL;

    -- Construct the dynamic SQL to unpivot the products table
    SELECT 
        GROUP_CONCAT(
            CONCAT(
    ...
    -- Prepare, execute, and deallocate the dynamically constructed SQL
